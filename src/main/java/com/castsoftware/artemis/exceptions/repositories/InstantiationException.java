...
public class InstantiationException extends ExtensionException {
    ...
    public InstantiationException(String message, Throwable cause, String code) {
        super(MESSAGE_PREFIX.concat(message), cause, CODE_PREFIX.concat(code));
    }

    public InstantiationException(String message, String code) {
        super(MESSAGE_PREFIX.concat(message), CODE_PREFIX.concat(code));
    }

    public InstantiationException(String message, String query, Throwable cause, String code) {
