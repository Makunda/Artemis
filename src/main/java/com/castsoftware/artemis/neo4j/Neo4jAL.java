...
public class Neo4jAL {
  ...
  /**
   * Log in the Neo4j neo4j.log file
   *
   * @param message Message to log
   */
  public void logInfo(String message) {
    log.info("ARTEMIS :: INFO :: " + message);
  }

  /**
   * Log in the Neo4j neo4j.log file as an error
   *
   * @param message Message to log
   */
  public void logError(String message) {
    log.error("ARTEMIS :: ERROR :: " + message);
  }
  ...
  public void logError(String message, Throwable e) {
    log.error("ARTEMIS :: ERROR :: " + message, e);
  }
}
