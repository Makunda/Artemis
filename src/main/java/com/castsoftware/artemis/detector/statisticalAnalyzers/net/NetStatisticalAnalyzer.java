...
package com.castsoftware.artemis.detector.statisticalAnalyzers.net;
...
public class NetStatisticalAnalyzer extends AStatisticalAnalyzer {
	/**
	 * Constructor
	 *
	 ...
	 */
	public NetStatisticalAnalyzer(Neo4jAL neo4jAL, String application, SupportedLanguage language) {
	...
	private void log(String message) {
		neo4jAL.logInfo(String.format("NET STATISTICAL ANALYZER :: %s", message));
	}
	...
	private void error(String message) {
		neo4jAL.logError(String.format("NET STATISTICAL ANALYZER :: %s", message));
	}
	...
	private void error(String message, Throwable err) {
		neo4jAL.logError(String.format("NET STATISTICAL ANALYZER :: %s", message), err);
	}
	...
	public void flagCore() throws Neo4jQueryException {
		...
		// Create a treeD
		NetFrameworkTree tree = TreeFactory.createNetTree(languageProp, nodeList);
