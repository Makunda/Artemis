...
public abstract class ALeaf {
  ...
  protected static final String IMAGING_MODULE_PROP =
      Configuration.get("imaging.node.object.module");
  protected static final String IMAGING_SUBSET_PROP =
      Configuration.get("imaging.node.object.subset");
