...
public class InteractionsProcedure {
  ...
  @Description(
      "artemis.get.interactions(String ApplicationContext, String language, Boolean flagNodes) - Get the interactions in an application")
  public Stream<OutputMessage> launchDetection(
    ...
    try {
      ...
      List<OutputMessage> detectedFrameworks =
          InteractionsController.launchDetection(nal, applicationContext, language, flagNodes);
