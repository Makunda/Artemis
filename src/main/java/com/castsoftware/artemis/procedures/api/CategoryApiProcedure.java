...
public class CategoryApiProcedure {
    ...
    @Description(
            "artemis.api.category.get.all.nodes() - Get all the category nodes")
    ...
    public Stream<CategoryNodeResult> updateNode(@Name(value="Id") Long id,
                                                   @Name(value="Name") String name,
                                                   @Name(value = "IconUrl", defaultValue = "") String iconUrl) throws ProcedureException {
    ...
    @Description(
            "artemis.api.category.get.node.byId(Long idNode) - Get a category node by its id")
    public Stream<CategoryNodeResult> getById(@Name(value="IdNode") Long idNode) throws ProcedureException {
    ...
    public Stream<CategoryNodeResult> createNode(@Name(value="Name") String name,
                                                   @Name(value = "IconUrl", defaultValue = "") String iconUrl) throws ProcedureException {
    ...
    @Description(
            "artemis.api.category.remove.node(Long idNode) - Remove a category Node")
    public Stream<BooleanResult> removeNode(@Name(value="idNode") Long idNode) throws ProcedureException {
