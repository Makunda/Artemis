...
public class PythiaProcedure {
    ...
    @Procedure(value = "artemis.pythia.get.lastUpdate", mode = Mode.WRITE)
    @Description(
            "artemis.pythia.get.lastUpdate() - Get the last update of the oracle")
    public Stream<OutputMessage> getLastUpdate() throws ProcedureException {
        ...
        try {
            ...
            String lastUpdate = PythiaComController.getLastUpdate(nal);

            return Stream.of(new OutputMessage(lastUpdate));
    ...
    @Procedure(value = "artemis.pythia.get.connection", mode = Mode.WRITE)
    @Description(
            "artemis.pythia.get.connection() - Check if Artemis is connected to the Pythia")
    ...
    @Procedure(value = "artemis.pythia.pull.frameworks", mode = Mode.WRITE)
    @Description(
            "artemis.pythia.pull.frameworks() - Check if Artemis is connected to the Pythia")
