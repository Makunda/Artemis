...
public class CategoryNode {
    ...
    public CategoryNode(Node n) throws Neo4jBadNodeFormatException {
        ...
        this.iconUrl = (String) n.getProperty(ICON_URL_PROPERTY);
            ...
            throw new Neo4jBadNodeFormatException(String.format("Category Node with id '%d' is not correctly formatted : %s", node.getId(), e.getLocalizedMessage()), "REGEXxCONS1");
        }
    }
     ...
     */
    public static CategoryNode getNode(Neo4jAL neo4jAL, Long idNode) throws Neo4jQueryException, Neo4jBadNodeFormatException {
